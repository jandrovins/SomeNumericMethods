...
function falsi_regula(x₀::Float64, x₁::Float64, f::Function, fₑ::Function, tolerance::Float64, iterations::Int64)
...
function fy(x)
    return exp(3x-12) + x*cos(3x) - x^2 + 4
end
...
left, right = falsi_regula(left, right, fy, abs_error, tolerance, iterations)
